...
fun Context.getErrorMessage(error: ConversationsError): String {
    return when (error) {
        ...
        ConversationsError.MEMBER_FETCH_FAILED -> getString(R.string.err_failed_to_fetch_participants)
        ConversationsError.MEMBER_ADD_FAILED -> getString(R.string.err_failed_to_add_participant)
        ConversationsError.MEMBER_REMOVE_FAILED -> getString(R.string.err_failed_to_remove_participant)
